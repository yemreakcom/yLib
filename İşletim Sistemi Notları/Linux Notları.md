...
echo alias "xampp_restart='/opt/lampp/xampp restart'" >> ~/.bashrc
echo alias "xampp_start='/opt/lampp/xampp start'" >> ~/.bashrc
echo alias "xampp_stop='/opt/lampp/xampp stop'" >> ~/.bashrc
